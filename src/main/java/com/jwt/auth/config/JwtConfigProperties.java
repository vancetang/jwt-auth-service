 ...
 * 使用 {@code @ConfigurationProperties(prefix = "jwt")} 將 {@code jwt.*} 前綴的屬性綁定到此類別的欄位。
 * </p>
 */
...
public class JwtConfigProperties {
     ...
     * 不應硬編碼或提交到版本控制系統中。
     * </p>
     * <p>範例 (application.yml): {@code secretKey: "your-super-secret-base64-encoded-key"}</p>
     */
    private String secretKey;

    /**
     * JWT 的發行者（iss）聲明。識別發行 JWT 的主體。
     * <p>範例 (application.yml): {@code issuer: "my-auth-service"}</p>
     */
    private String issuer;

    /**
     * JWT 的受眾（aud）聲明。識別 JWT 的預期接收者。
     * <p>範例 (application.yml): {@code audience: "my-app-client"}</p>
     */
    private String audience;

    /**
     * Access Token 的過期時間（毫秒）。
     * <p>預設值：3,600,000 毫秒（1 小時）。</p>
     * <p>範例 (application.yml): {@code accessTokenExpirationMs: 3600000}</p>
     */
    private long accessTokenExpirationMs = 3600000L; // 1 hour in milliseconds

    /**
     * Refresh Token 的過期時間（毫秒）。
     * <p>預設值：86,400,000 毫秒（24 小時）。</p>
     * <p>範例 (application.yml): {@code refreshTokenExpirationMs: 86400000}</p>
     */
     ...
     * <p>預設值：3,600,000 毫秒（1 小時）。</p>
     * <p>用於 {@link com.jwt.auth.security.JwtTokenProvider#cleanupInvalidatedJtis()} 方法的 {@code @Scheduled} 註解。</p>
     */
     ...
     * <p>預設值：86,400,000 毫秒（24 小時）。</p>
     * <p>用於 {@link com.jwt.auth.security.JwtTokenProvider#cleanupInvalidatedJtis()} 方法，以確保已過期的 JTI 不會立即被清除。</p>
     */
